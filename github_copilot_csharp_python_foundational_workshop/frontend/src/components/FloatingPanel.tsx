...
import { Truck, MapPin, Navigation, Plus, X, Search, GripVertical, Coffee, Fuel, Bed, List, Sparkles, Save, FolderOpen, Loader2, LogIn } from 'lucide-react';
...
const FloatingPanel: React.FC = () => {
  const { vehicleSpecs, setVehicleSpecs, stops, addStop, removeStop, setRouteData, reorderStops, routeDistance, routeGeoJSON, pois, setPOIs, routeLegs, setStops, saveTrip, loadTrips, loadTrip } = useTripStore();
  ...
  return (
    <div className="pointer-events-auto absolute top-4 left-0 md:left-4 w-full md:w-96 bg-white md:rounded-xl shadow-2xl flex flex-col overflow-hidden max-h-[calc(100vh-5rem)] md:max-h-[90vh]">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {activeTab === 'vehicle' && (
          <VehicleTab vehicleSpecs={vehicleSpecs} setVehicleSpecs={setVehicleSpecs} />
        )}
